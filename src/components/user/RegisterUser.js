    ...
    <div className="rounded flex max-w-2xl mx-auto shadow border-b bg-white mt-3 mb-16  min-h-fit w-fit">
        <div className="px-8 py-8">
            ...
            <div className="items-center justify-center h-14 w-full my-4 space-x-4 pt-4">
                <button onClick={createUser} className=' rounded font-semibold bg-green-400 py-2 px-2 hover:bg-green-800'>
                    Register
                </button>
                <button  onClick={() => navigate("/login")} className=' rounded font-semibold bg-green-400 py-2 px-2 hover:bg-green-800'>
                    Login
                </button>
            </div>
            <Footer/>
